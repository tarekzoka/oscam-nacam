...
#!/bin/sh
#
wget -O /tmp/enigma2-plugin-softcams-oscam_11740-emu-r798_all.deb "https://github.com/tarekzoka/oscam-nacam/blob/main/enigma2-plugin-softcams-oscam_11740-emu-r798_all.deb?raw=true"
wait
