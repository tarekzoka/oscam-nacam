...
#!/bin/sh
#
wget -O /tmp/enigma2-softcams-oscam-all-images_11748-emu-r799-arm+mips_all.deb "https://github.com/tarekzoka/oscam-nacam/blob/main/enigma2-softcams-oscam-all-images_11748-emu-r799-arm+mips_all.deb?raw=true"
wait
